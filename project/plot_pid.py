...
def read_steer_data():
 ...
 steer_df.columns = ['Iteration', 'Error Steering', 'Steering Output', 'Yaw', 'Desired Yaw']
 print(f'Steer data:\n{steer_df.head()}\n')
 return steer_df
...
def read_throttle_data():
 ...
 throttle_df.columns = ['Iteration', 'Error Throttle', 'Brake Output', 'Throttle Output', 'Velocity', 'Desired Velocity']
...
def plot_steer_reference(steer_df, n_rows):   
 steer_df2 = steer_df[:n_rows]
...
def plot_throttle_reference(throttle_df, n_rows):   
 throttle_df2 = throttle_df[:n_rows]
 throttle_df2.plot(x = throttle_df.columns[0], y = [throttle_df.columns[4], throttle_df.columns[5]], kind = 'line')
 plt.show()
...
def main():
 ...
 plot_throttle_reference(throttle_df, n_rows)
 plot_steer_reference(steer_df, n_rows) 
